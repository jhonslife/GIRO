...
impl<'a> ProductRepository<'a> {
    ...
    fn product_columns_string(&self) -> String {
        let mut cols: Vec<String> = vec![
            ...
            // Automotive Fields
            "oem_code".to_string(),
            "aftermarket_code".to_string(),
            "part_brand".to_string(),
            "application".to_string(),
        ];
        // monetary/quantity fields
        cols.push("sale_price".to_string());
        cols.push("cost_price".to_string());
        cols.push("current_stock".to_string());
        cols.push("min_stock".to_string());
        cols.push("max_stock".to_string());
    ...
    pub async fn create(&self, data: CreateProduct) -> AppResult<Product> {
        ...
        sqlx::query(
            "INSERT INTO products (
                ...
                is_active, category_id, oem_code, aftermarket_code, part_brand, \"application\", created_at, updated_at
